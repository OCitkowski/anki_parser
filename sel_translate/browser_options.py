...
# Отже, щоб зменшити вірогідність ідентифікації як бота, можна використовувати такі налаштування:
#
...
#     '--disable-background-timer-throttling': вимкнути затримки таймерів у фонових вкладках
